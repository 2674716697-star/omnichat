...
const REQUIRED = [
  ...
  'callChatModel',
  'buildAuxMessages',
  'buildStoryMemoryAuxPrompt',
  'resolveStoryAuxProviderAndModel',
  'tryParseAuxResponse',
  'tryParseStoryMemoryResponse',
  'buildStoryMemorySystemText',
  'applyStoryMemoryUpdate',
  'scheduleStoryMemoryUpdate',
  'scheduleLocalStoryMemoryUpdate',
  'LocalMemoryAdapter',
  'MockRemoteMemoryAdapter',
  'RemoteMemoryAdapter',
