...
check('no auto-fallback — fake status/options disabled', /No auto-fallback/.test(js));
check('existing _sceneFallbackAttempted guard removed', !/_sceneFallbackAttempted\s*=\s*true/.test(js));
